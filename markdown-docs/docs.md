...
- 🐛 **Fixed**: Fixes regression in [`sequentialInteger`](/functions/sequentialInteger) when paired with `startingFrom` value.

---

###  2.1.2

Mon Aug 17 15:42:55 PDT 2026

### Changes

- 🐛 **Fixed**: Mitigates [CVE-2026-59902](https://nvd.nist.gov/vuln/detail/CVE-2026-59902).
...
- 🐛 **Fixed**: Mitigates [CVE-2026-10050](https://nvd.nist.gov/vuln/detail/CVE-2026-10050).
...
- 🐛 **Fixed**: Mitigates [CVE-2026-44891](https://nvd.nist.gov/vuln/detail/CVE-2026-44891).

---

###  1.19.7

Thu Jul  9 08:23:33 PDT 2026

### Changes

- 🐛 **Fixed**: Mitigates [CVE-2026-54515](https://nvd.nist.gov/vuln/detail/CVE-2026-54515).
- 🐛 **Fixed**: Mitigates [CVE-2026-10532](https://nvd.nist.gov/vuln/detail/CVE-2026-10532).
- 🐛 **Fixed**: Mitigates [CVE-2026-9828](https://nvd.nist.gov/vuln/detail/CVE-2026-9828).
- 🐛 **Fixed**: Mitigates [CVE-2026-6791](https://nvd.nist.gov/vuln/detail/CVE-2026-6791).

---

###  1.19.6

Thu Jun 25 08:42:17 PDT 2026

### Changes

- 🐛 **Fixed**: Mitigates [CVE-2026-54512](https://nvd.nist.gov/vuln/detail/CVE-2026-54512).
- 🐛 **Fixed**: Mitigates [CVE-2026-54513](https://nvd.nist.gov/vuln/detail/CVE-2026-54513).
- 🐛 **Fixed**: Mitigates [CVE-2026-54514](https://nvd.nist.gov/vuln/detail/CVE-2026-54514).
- 🐛 **Fixed**: Mitigates [CVE-2026-54515](https://nvd.nist.gov/vuln/detail/CVE-2026-54515).
...
- 🐛 **Fixed**: Mitigates [CVE-2026-33117](https://nvd.nist.gov/vuln/detail/CVE-2026-33117).

---

###  1.18.6

Thu Jun  4 11:25:08 PDT 2026

### Changes

- ⚡ **Improved**: Improves memory utilization/performance for Iceberg, JSON, JSONL, and log serialization formats.

---

###  1.18.5

Fri May 29 09:53:09 PDT 2026

### Changes

- 🐛 **Fixed**: Fixes Redis's `unlink` startup policy for non-templated patterns in multi node clusters.

---

###  1.18.4

Thu May 21 08:30:22 PDT 2026

### Changes

- 🐛 **Fixed**: Mitigates [CVE-2026-45205](https://nvd.nist.gov/vuln/detail/CVE-2026-45205).
...
- 🐛 **Fixed**: Mitigates [CVE-2026-42583](https://nvd.nist.gov/vuln/detail/CVE-2026-42583).
- 🐛 **Fixed**: Mitigates [CVE-2026-42579](https://nvd.nist.gov/vuln/detail/CVE-2026-42579).
- 🐛 **Fixed**: Mitigates [CVE-2026-42584](https://nvd.nist.gov/vuln/detail/CVE-2026-42584).
- 🐛 **Fixed**: Mitigates [CVE-2026-42587](https://nvd.nist.gov/vuln/detail/CVE-2026-42587).
- 🐛 **Fixed**: Mitigates [CVE-2026-41417](https://nvd.nist.gov/vuln/detail/CVE-2026-41417).
- 🐛 **Fixed**: Mitigates [CVE-2026-42580](https://nvd.nist.gov/vuln/detail/CVE-2026-42580).
- 🐛 **Fixed**: Mitigates [CVE-2026-42581](https://nvd.nist.gov/vuln/detail/CVE-2026-42581).
- 🐛 **Fixed**: Mitigates [CVE-2026-42585](https://nvd.nist.gov/vuln/detail/CVE-2026-42585).
- 🐛 **Fixed**: Mitigates [CVE-2026-42582](https://nvd.nist.gov/vuln/detail/CVE-2026-42582).
- 🐛 **Fixed**: Mitigates [CVE-2026-44248](https://nvd.nist.gov/vuln/detail/CVE-2026-44248).
- 🐛 **Fixed**: Mitigates [CVE-2026-42586](https://nvd.nist.gov/vuln/detail/CVE-2026-42586).
- 🐛 **Fixed**: Mitigates [CVE-2026-42578](https://nvd.nist.gov/vuln/detail/CVE-2026-42578).
- 🐛 **Fixed**: Mitigates [CVE-2026-42577](https://nvd.nist.gov/vuln/detail/CVE-2026-42577).
...
- ⚡ **Improved**: Improves Iceberg writing performance.
...
- 🐛 **Fixed**: Fixes issues where Iceberg S3 files are written with a superfluous leading slash.
...
- 🐛 **Fixed**: Fixes Redis's `unlink` startup policy for multi node clusters.
...
- ✅ **Added**: Adds new [Databricks](/connections/databricks) connection.
...
- 🐛 **Fixed**: Mitigates [CVE-2026-33870](https://nvd.nist.gov/vuln/detail/CVE-2026-33870).
- 🐛 **Fixed**: Mitigates [CVE-2026-33871](https://nvd.nist.gov/vuln/detail/CVE-2026-33871).
...
- 🐛 **Fixed**: Mitigates [CVE-2025-67721](https://nvd.nist.gov/vuln/detail/CVE-2025-67721).
...
- 🐛 **Fixed**: Fixes peformance regression in [`histogram`](/functions/histogram/).
...
- 🐛 **Fixed**: Fixes false positive from linter on [`avroHint`](/function-modifiers/avroHint)
...
- ⚡ **Improved**: Upgrades the [SQL Server connection](/connections/sqlServer) driver.
...
- ✅ **Added**: Adds new [`profile`](/functions/profile) function for generating realistic data about people.
...
- 🐛 **Fixed**: Tightens schemas for [`string`](/functions/string), [`heading`](/functions/heading), and [`loadJsonFile`](/functions/loadJsonFile).
...
- 🐛 **Fixed**: Fixes Kafka tombstone validation when using Schema Registry serializers. ShadowTraffic previously inappropriately applied schema checks on null value payloads.
...
- 🐛 **Fixed**: Mitigates [CVE-2025-68973](https://nvd.nist.gov/vuln/detail/CVE-2025-68973).
...
- ⚡ **Improved**: Kafka topics can now be created with custom configuration.
...
- 🐛 **Fixed**: Fixes bug that prevented manual table policies from working with backticks in MySQL.
...
- 🐛 **Fixed**: Fixes OS CVEs in the ShadowTraffic Oracle Linux base image.
...
You can authenticate using either OAuth M2M [Example 1](#connecting-with-m2m) or Personal Access tokens [Example 2](#connecting-with-pat).
...
Specify `clientId` and `clientSecret` to connect with [Databricks OAuth M2M](https://docs.databricks.com/aws/en/dev-tools/auth/oauth-u2m). ShadowTraffic will automatically refresh your token each time it expires.
...
Alternatively, you can specify `token` in the configuration map to connect with a Databricks [Personal Access Token (PAT)](https://docs.databricks.com/aws/en/dev-tools/auth/pat).
...
Additionally, you can optionally specify any further Kafka topic configuration (such as `retention.ms`) with the `topicConfigs` parameter. The keys and values in `topicConfigs` correspond to the configuration that you would pass to Kafka's Admin client, and as such, all values must be strings.

For example, this `topicPolicy` creates a topic with 6 partitions, a replication factor of 2, and a retention time of 1 day.
...
[
  {
    ...
    "where": null,
    "row": {
      "email": "judson.mills@hotmail.com"
    },
    "table": "a"
  },
  {
    "headers": null,
    "topic": "b",
    "value": "judson.mills@hotmail.com",
    "key": null
  },
  {
    "op": null,
...
Set `strategy` to `first` to lookup the first event generated. This is useful if you want to grab the data a generator initialized with. Note that "first" refers to the head of the [generator's history](/generator-configuration/maxHistoryEvents/), so as its history deletes data in a first-in-first out manner, this value may change.
...
In this example, notice how each value for `b` lock onto the most event value generated by `a`.
...
[
  ...
  },
  {
    ...
    "topic": "b",
    "value": {
      "lookedUpName": "Beverlee Hodkiewicz V",
      "lookedUpNumber": 7
    },
    "key": null
  },
...
[
  ...
  },
  {
    ...
    "topic": "sandbox",
    "value": [
      "expedita_id/tenetur.css",
      "nobis_veritatis/eos.js",
      "expedita_animi/odio.doc",
      "tempora_ab/nemo.mp3",
      "officia_natus/quas.mp3"
    ],
    "key": null
  },
  {
...
[
  {
    "headers": null,
    "topic": "sandbox",
    "value": "2024-02-03 12:19:55.440093169",
    "key": null
  },
  {
    "headers": null,
    "topic": "sandbox",
    "value": "2024-09-03 17:58:37.01507324",
    "key": null
  },
  {
    "headers": null,
    "topic": "sandbox",
    "value": "2024-03-01 01:08:29.669982414",
    "key": null
  }
]
```
...
[
  {
    ...
    "topic": "sandbox",
    "value": {
      "scrubbed": "MarikoGaylord",
      "upper": "MR. DOLORES THOMPSON",
      "capitalized": "Kelly kunze",
      "shortened": "Nia",
      "lower": "libby hand"
    },
    "key": null
  },
  {
    ...
    "value": {
      "scrubbed": "JimmyWalsh",
      "upper": "YOULANDA BEATTY JR.",
      "capitalized": "Ned botsford",
      "shortened": "Amm",
      "lower": "reginald adams"
    },
    "key": null
  }
]
...
This configuration works on all SQL connections, including [Postgres](/connections/postgres), [MotherDuck](/connections/motherduck), [MySQL](/connections/mysql), [SQL Server](/connections/sqlServer), [Databricks](/connections/databricks), and [Oracle](/connections/oracle).
